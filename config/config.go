...
func GetCategory() map[int]map[string]string {
	cat := map[int]map[string]string{
		1: {"title": "cos套图", "url": "https://www.jdlingyu.mobi/tuji/hentai/costt", "cat": "catL1183"},
		2: {"title": "国产套图", "url": "https://www.jdlingyu.mobi/tuji/hentai/gctt", "cat": "catL1182"},
		3: {"title": "日本写真", "url": "https://www.jdlingyu.mobi/tuji/hentai/rbxz", "cat": "catL1181"},
	}
	return cat
}
